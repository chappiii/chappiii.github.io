...
function NavBar() {
  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0">
      <div className="md:flex items-center justify-between bg-slate-950 py-4 md:px-10 px-7">
        <div
      ...
      text-gray-800"
        ...
        <ul
          className={`md:flex md:items-center bg-slate-950 md:pb-0 mt-2 md:mt-0 pb-12  absolute md:static  md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
